...
2.  Search for "Product Editor Pro".
3.  Click **Install Now** and then **Activate**.
4.  Go to **Products > Product Editor** to start editing.

== Frequently Asked Questions ==

= Is it compatible with the latest WooCommerce? =
Yes, Product Editor Pro is fully compatible with WooCommerce 9.0+ and HPOS.

= Can I schedule sales for Black Friday? =
...
Yes! Product Editor Pro fully supports simple products, variable products (and their variations), and external products.

= Can I filter products by custom taxonomies? =
Yes! You can search and filter products by any custom taxonomy, not just standard categories and tags.
...
= 2.2.0 =
* NEW: Promotional banner with discount code PROMO15
* NEW: Upgrade modal with special offer when reaching product limit
* NEW: Review request popup after successful bulk operations
* NEW: Social proof on license page (ratings, installations)
* NEW: FOMO countdown timer on pricing page
* IMPROVED: Better conversion optimization
* CHANGED: Support email updated to support@speitzako-app.com

= 2.1.0 =
* NEW: Advanced Bulk Editing Features (Premium)
* NEW: Bulk edit Stock Quantities & Status
* NEW: Bulk edit Categories & SKU
* NEW: Bulk edit Weight
* IMPROVED: User Interface and Performance

= 2.0.0 =
* Major update: Introduction of Premium features
* Added Scheduling for price changes

= 1.0.17 =
* Fixed: Non-standard admin path compatibility